...
def generate_launch_description():
    ...
    pkg_path= FindPackageShare(package='my_bot').find('my_bot')
    rviz_config_path = os.path.join(pkg_path, 'config/main.rviz')
    urdf_model_path = os.path.join(pkg_path, 'urdf/robot.urdf.xacro')

    # Launch configuration variables specific to simulatione4edexds
